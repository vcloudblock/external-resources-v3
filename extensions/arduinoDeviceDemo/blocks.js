        ...
        init: function () {
            this.jsonInit({
                ...
                args0: [
                    {
                        type: 'field_image',
                        src: ultraSonicDistanceSensorIco,
                        width: 30,
                        height: 30
                    }
                ],
